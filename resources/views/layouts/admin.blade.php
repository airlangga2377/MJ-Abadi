...
<head>
  ...
  {{-- <link href="https://cdn.datatables.net/1.13.11/css/dataTables.dataTables.min.css" rel="stylesheet"> --}}
  ...
  <link href="https://cdn.datatables.net/select/2.0.1/css/select.dataTables.min.css" rel="stylesheet" />
...
<body class="app header-fixed sidebar-fixed aside-menu-fixed pace-done sidebar-lg-show">
    ...
    {{-- <script src="https://cdn.datatables.net/1.13.11/js/dataTables.min.js"></script> --}}
    ...
    <script src="https://cdn.rawgit.com/bpampuch/pdfmake/0.2.10/build/pdfmake.min.js"></script>
    <script src="https://cdn.rawgit.com/bpampuch/pdfmake/0.2.10/build/vfs_fonts.js"></script>
  ...
  let languages = {
    'id': 'https://cdn.datatables.net/plug-ins/2.0.3/i18n/id.json'
